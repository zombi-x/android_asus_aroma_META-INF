...
fs="ext4" # Filesystem
cache="/dev/block/mmcblk0p2" # Cache partition, used by eval in stages 2+, SC2034
system="/dev/block/mmcblk0p1" # System partition, used by eval in stages 2+, SC2034
data="/dev/block/mmcblk0p8" # Data and internal memory, used by eval in stages 2+, SC2034
datae="/dev/block/mmcblk1p2" # Data and external memory, used by eval in stages 2+, SC2034
